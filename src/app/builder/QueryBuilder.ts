...
//   private model: any;
//   private query: Record<string, unknown>;
//   private prismaQuery: any = {}; // Flexible structure for Prisma query
...
//     // ✅ Automatically filter out records with missing required relations
//     if (this.prismaQuery.include?.mechanic) {
//       formattedFilters["mechanic"] = { isNot: null };
//     }
